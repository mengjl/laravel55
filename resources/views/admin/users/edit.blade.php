...
@section('title','管理后台-用户修改')
@section('pageHeader')
<div class="pageheader">
      <h2><i class="fa fa-home"></i> 管理后台用户修改<span>Subtitle goes here...</span></h2>
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body panel-body-nopadding">
          ...
          {{csrf_field()}} 
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                ...
                <img src="{{$user->image_url}}" alt="" style="width: 50px;">
              </div>
            </div>
           ...
           <div class="radio"><label><input type="radio" name="is_super" value="2" @if($user->is_super == 2)checked @endif>是</label></div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
           <div class="radio"><label><input type="radio" name="status" value="1" @if($user->is_super == 1)checked @endif>正常</label></div>
           <div class="radio"><label><input type="radio" name="status" value="2" @if($user->is_super == 2)checked @endif>禁用</label></div>
          ...
          <!-- <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" placeholder="Default Input" class="form-control" name="sort" value="100" />
              </div>
            </div> -->
                   ...
                   <div class="row">
                    <div class="col-sm-6 col-sm-offset-3">
                      <button class="btn btn-primary btn-danger" id="btn-save">修改权限</button>
