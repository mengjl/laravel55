...
<div class="pageheader">
      <h2><i class="fa fa-home"></i> 管理后台用户添加 <span>Subtitle goes here...</span></h2>
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body panel-body-nopadding">
          ...
          {{csrf_field()}} 
           ...
           <div class="radio"><label><input type="radio" name="is_super" value="2" checked>是</label></div>
           ...
           <div class="radio"><label><input type="radio" name="status" value="2" checked>禁用</label></div>
