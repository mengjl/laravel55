...
@section('title','管理后台角色添加')
@section('pageHeader')
<div class="pageheader">
      <h2><i class="fa fa-home"></i> 管理后台角色添加 <span>Subtitle goes here...</span></h2>
        ...
        <div class="panel-body panel-body-nopadding">
          ...
          {{csrf_field()}} 
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" placeholder="角色名字" class="form-control" name="role_name" />
              </div>
            </div>
            <div class="form-group">
